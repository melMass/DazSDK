...
/**
	@sdk
	@file
	Defines the DzTranslateTool class.
**/

#ifndef DAZ_TRANSLATE_TOOL_H
#define DAZ_TRANSLATE_TOOL_H
...
class DZ_EXPORT DzTranslateTool : public DzTransformTool {
	Q_OBJECT
public:
	//
	// CREATORS
