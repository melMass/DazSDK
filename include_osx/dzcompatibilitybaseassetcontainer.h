...
/**
	@sdk
	@file
	Defines the DzCompatibilityBaseAssetContainer class.
**/

#ifndef DAZ_COMPATIBILITY_BASE_CONTAINER_H
#define DAZ_COMPATIBILITY_BASE_CONTAINER_H
...
class DZ_EXPORT DzCompatibilityBaseAssetContainer : public DzAbstractAssetContainer 
{
	Q_OBJECT
public:
	DzCompatibilityBaseAssetContainer( DzDBCompatibilityBaseTable *table, bool showFilters, DzAbstractAssetContainer *owner = NULL );

	virtual ~DzCompatibilityBaseAssetContainer();
...
public slots:
	...
	DzDBCompatibilityBaseTable*	getCompatibilityBaseTable();
...
typedef DzTSharedPointer<DzCompatibilityBaseAssetContainer> DzCompatibilityBaseAssetContainerPtr;
Q_DECLARE_METATYPE(DzCompatibilityBaseAssetContainerPtr);

#endif // DAZ_COMPATIBILITY_BASE_CONTAINER_H
