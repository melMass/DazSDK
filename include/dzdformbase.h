...
/**
	@sdk
	@file
	Defines the DzDFormBase class.
**/

#ifndef DAZ_DFORM_BASE_H
#define DAZ_DFORM_BASE_H
...
class DZ_EXPORT DzDFormBase : public DzNode {
	Q_OBJECT
	friend class DzDForm;
	friend class DzDFormBaseFactory;
public:
	DzDFormBase();
	virtual ~DzDFormBase();
...
protected:
	DzDFormBase( const DzInFile *file );
